...
//We are ready baby
$loginmsg='Autentica��o necess�ria';
if($_POST && (!empty($_POST['lemail']) && !empty($_POST['lticket']))):
    ...
    if($_SESSION['_client']['laststrike']) {
        if((time()-$_SESSION['_client']['laststrike'])<$cfg->getClientLoginTimeout()) {
            ...
            $errors['err']='Voc� alcan�ou o m�mximo de tentativas de logon permitidas. Tente novamente mais tarde ou <a href="open.php">abra um novo ticket</a>';
