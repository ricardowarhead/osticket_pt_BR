<? if(!defined('OSTSCPINC') || !is_object($thisuser) || !$thisuser->isStaff() || !is_object($nav)) die('Acesso Negado'); ?>
<html>
<head>
...
?>
<title>osTicket :: Painel de Controle do Atendente</title>
    ...
    <div id="header">
        ...
        <p id="info">Bem-vindo de volta, <strong><?=$thisuser->getUsername()?></strong> 
           <?php
            ...
            <?}else{?>
            | <a href="index.php">Painel do Atendente</a>
            <?}?>
    ...
    <div id="nav">
        <ul id="main_nav" <?=!defined('ADMINPAGE')?'class="dist"':''?>>
            ...
            <?}
                ...
                <li><a href="profile.php" title="My Preference">Minha Conta</a></li>
            <?}?>
        </ul>
        <ul id="sub_nav">
            <?php
