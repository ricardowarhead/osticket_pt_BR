...
<div class="msg">Assunto: <?=Format::htmlchars($ticket->getSubject())?></div>
<div>
    <?if($errors['err']) {?>
...
<br>
<div align="left">
    <span class="Icon thread">Progresso do Ticket</span>
    <div id="ticketthread">
        <?
	    //get messages
...
<div>
    ...
    <div id="reply" style="padding:10px 0 20px 40px;">
        ...
        <form action="view.php?id=<?=$id?>#reply" name="reply" method="post" enctype="multipart/form-data">
            ...
            <div align="left">
                Mensagem <font class="error">*&nbsp;<?=$errors['message']?></font><br/>
